...
export const WaitingMonthView = ({ currentDate, getWaitlistForDate, setCurrentDate, setViewMode }: WaitingMonthViewProps) => {
        ...
        return (
          ...
          >
            ...
            <div className="space-y-1">
              ...
              {dayWaitlist.slice(0, 2).map((entry) => (
                <div 
                  key={entry.id} 
